...
const PANEL_PRESETS: PresetMeta[] = [
  { id: "TROPTIONS_SALES_ASSISTANT",      label: "Sales",       defaultMessage: "What sales opportunities exist with the current open listings and options pipeline?" },
  ...
  return (
    <div className="space-y-10">
      ...
      <div className="flex items-start justify-between flex-wrap gap-4">
        <div>
          <p className="text-xs font-bold text-cyan-400 uppercase tracking-widest mb-1">TROPTIONS Sales Engine</p>
          <h1 className="text-3xl font-extrabold text-white">Sales Dashboard</h1>
          <p className="text-gray-400 text-sm mt-1">
            Commission tracking · Deal pipeline · Payout audit trail
          </p>
        </div>
        <div className="flex gap-3">
          <a
            href="/market/list"
            className="bg-yellow-400 text-gray-950 font-bold px-4 py-2 rounded-lg hover:bg-yellow-300 text-sm transition-colors"
          >
            + New Listing
          </a>
          <a
            href="/options/write"
            className="border border-cyan-500 text-cyan-400 font-bold px-4 py-2 rounded-lg hover:bg-cyan-500/10 text-sm transition-colors"
          >
            + Write Option
          </a>
        </div>
      ...
      <a href="/infrastructure/ai" className="block">
        <div className={`rounded-xl border px-4 py-2.5 flex items-center justify-between text-xs transition-colors hover:opacity-90 ${
          ...
          aiProvider === "loading" ? "bg-gray-900 border-gray-800"          :
      ...
      {/* AI Assistant Panel */}
      <section className="bg-gray-900 border border-purple-800/40 rounded-2xl p-6 space-y-4">
      ...
      {/* Commission meter */}
      <section className="bg-gray-900 border border-cyan-800/40 rounded-2xl p-6 space-y-4">
        <div className="flex items-center justify-between">
        ...
        {loading ? (
          ...
          <div className="text-center py-16 text-gray-500">
            ...
            <p className="text-xs mt-2">
              <a href="/market/list" className="text-yellow-400 underline">List a card</a> to start.
            </p>
          </div>
        ) : (
...
function KpiCard({
  ...
  const color = accent === "yellow" ? "text-yellow-400" : "text-cyan-400";
  return (
...
function InfoCard({
  ...
  return (
    <div className={`bg-gray-900 border ${color} rounded-xl p-5 space-y-2`}>
