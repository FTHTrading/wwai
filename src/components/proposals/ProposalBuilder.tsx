    ...
    <div className="grid lg:grid-cols-2 gap-6">
      ...
      <div className="wwai-panel p-5 space-y-3">
        <div className="print-only print-header">
          <div>
            <div style={{ fontSize: 22, fontWeight: 800 }}>TROPTIONS · WWAI</div>
            <div style={{ fontSize: 11, color: "#475569" }}>Independent SalesOS + GuestOps for major event cities</div>
          </div>
        ...
        <div className="print-only" style={{ fontSize: 12, color: "#0a1220" }}>
          <div><strong>Customer:</strong> {businessName || "Demo Business"} · {customerType}</div>
          <div><strong>Contact:</strong> {contactName || "Demo Contact"}</div>
          <div><strong>Zone:</strong> {zone} · <strong>Campaign:</strong> {campaignType}</div>
        </div>
        ...
        <div className="print-only" style={{ marginTop: 16, fontSize: 11, color: "#0a1220", borderTop: "1px solid #cbd5e1", paddingTop: 8 }}>
          <strong>Next steps:</strong> 1) Sign and return this proposal. 2) Kickoff call to gather data + integration keys. 3) Production launch via the TROPTIONS launch checklist.
          <div style={{ color: "#475569", marginTop: 6 }}>
            Demo proposal generated by TROPTIONS SalesOS. Independent platform; not affiliated with any protected sports league, event, team, venue, hotel, rideshare brand, or restaurant brand unless separately licensed.
          </div>
        </div>
      </div>
    </div>
