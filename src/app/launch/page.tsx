...
const SECTIONS = [
  ...
  { title: "Map provider",       items: ["Replace SVG demo with Mapbox / Google Maps / Azure Maps", "Wire real geocoding for hotels, restaurants, bars, drivers, venues"] },
  { title: "Routing",            items: ["Connect routing API (Mapbox Directions, Google Routes)", "Add safety-corridor scoring + operator review queue"] },
